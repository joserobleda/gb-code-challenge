describe("Respository View", function() {
	...
	it("should exist", function() {
		expect(App.Views.RepositoryView).toBeDefined();
	});

	it("should call model change on instance", function () {
		var spy 	= jasmine.createSpy('onChange');
		var repo 	= new App.Models.Repository({full_name: 'jquery/jquery'});

		repo.bind('change', spy);

		var view = new App.Views.RepositoryView({ model: repo });
		this.server.respond();

		expect(spy).toHaveBeenCalled();
	});

	it("should call render on instance", function () {
		var spy 	= spyOn(App.Views.RepositoryView.prototype, 'render');
	...
	it("should fire ready event", function () {
		var spy 	= jasmine.createSpy('onChange');
